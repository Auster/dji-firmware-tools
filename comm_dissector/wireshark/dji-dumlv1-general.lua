...
GENERAL_UART_CMD_TEXT = {
    ...
    [0x83] = 'SWARM Upgrade Request', -- verified in WM630; routed mobile <-> network
    [0x84] = 'SWARM Upgrade Negotiate', -- verified in WM630
    [0x85] = 'SWARM Upgrade Trigger', -- verified in WM630
