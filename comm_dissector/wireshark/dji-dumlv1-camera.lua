...
CAMERA_UART_CMD_TEXT = {
    ...
    [0x8E] = 'Params Option', -- ParamsOption
    ...
    [0xD8] = 'User Custom Info Get', -- GetUserCustomInfo
    [0xDA] = 'Opt Storage Config', -- OptStorageCfg
    [0xDB] = 'IRC Enable Set', -- IRCEnable
    [0xDD] = 'ND Filter Set',
    ...
    [0xE5] = 'Watermark Set', -- Watermark
    [0xE7] = 'Orig Photo Save Set', -- SetSaveOrigPhoto
    [0xE8] = 'Orig Photo Save Get', -- GetSaveOrigPhoto
